...
class BackboneVOC(torch.nn.Module):
    def __init__(self, class_num, anchor_base_num):
        super(BackboneVOC, self).__init__()
        self.darknet19 = DarkNet19()

        total_bbox_num = (5 + class_num) * anchor_base_num
