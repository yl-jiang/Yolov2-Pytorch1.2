...
if __name__ == '__main__':
    Aggregation = '/media/dk/MyFiles/Data/clustering/Aggregation.txt'
    raw_data = np.loadtxt(Aggregation, delimiter='	', usecols=[0, 1])
    main(raw_data)
